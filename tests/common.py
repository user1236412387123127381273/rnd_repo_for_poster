...
from bisa import load_shellcode, Project
from bisa.analyses import CongruencyCheck
import bisa.sim_options as so

l = logging.getLogger("bisa.tests.common")
...
if not os.path.isdir(bin_location):
    raise Exception(
        "Can't find the bisa/binaries repo for holding testcases. "
        "It should be cloned into the same folder as the rest of your bisa modules."
    )
