...
# rejected by bisa because there is no control flow instruction at the assembly
...
class TestFindAvoidConflict(unittest.TestCase):
    def test_find_avoid_conflict(self):
        proj = bisa.Project(os.path.join(bin_location, "tests", "i386", "ite_FindAvoidConflict-O3"))
