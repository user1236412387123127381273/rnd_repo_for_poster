...
class TestEcho(unittest.TestCase):
    def _run_echo_haha(self, arch):
        ...
        p = bisa.Project(os.path.join(test_location, arch, "echo"), use_sim_procedures=False)
        s = p.factory.full_init_state(
            mode="symbolic_approximating", args=["echo", "haha"], add_options={bisa.options.STRICT_PAGE_ACCESS}
        )
