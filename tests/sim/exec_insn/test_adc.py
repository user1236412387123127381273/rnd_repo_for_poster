...
class TestAdc(unittest.TestCase):
    def test_adc_i386(self):
        proj = bisa.Project(os.path.join(test_location, "i386", "test_adc"), load_options={"auto_load_libs": False})
        ...
        state = proj.factory.blank_state(
            addr=start,
            remove_options={
                bisa.options.LAZY_SOLVES,
            },
            add_options={bisa.options.SYMBOLIC_WRITE_ADDRESSES},
        )
