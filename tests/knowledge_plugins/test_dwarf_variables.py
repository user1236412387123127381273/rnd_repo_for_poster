...
class TestDwarfVariables(TestCase):
    ...
    def setUp(self):
        self.p = bisa.Project(os.path.join(test_location, "x86_64", "various_variables"), load_debug_info=True)
    ...
    def test_variable_scopes(self):
        simgr = self.p.factory.simgr()
        filename = "/home/lukas/Software/bisa-dev/binaries/tests_src/various_variables.c"
        lines_strings = [
            (78, b"He"),
            (80, b"llo "),
