...
import bisa
from bisa.engines.pcode.behavior import BehaviorFactory
from bisa.engines.pcode.emulate import PcodeEmulatorMixin
from bisa.sim_state import SimState
from bisa.engines import SimSuccessors
...
class TestPcodeEmulatorMixin(unittest.TestCase):
    ...
    def _step_irsb(irsb, state=None):
        emulator = PcodeEmulatorMixin(bisa.load_shellcode(b"\x90", arch="AMD64"))
    ...
    def _test_single_arith_binary_op(self, opcode: OpCode):
        ...
        if is_boolean:
            booleanize = bisa.engines.pcode.behavior.OpBehavior.booleanize
...
if __name__ == "__main__":
    ...
    logging.getLogger("bisa.engines.pcode").setLevel(logging.DEBUG)
    unittest.main()
