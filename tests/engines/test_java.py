...
import bisa
from bisa.storage.memory_mixins import JavaVmMemory, DefaultMemory, KeyValueMemory
from bisa.engines.soot.values import SimSootValue_ArrayRef, SimSootValue_ThisRef
from bisa.engines.soot.method_dispatcher import resolve_method
...
class TestJava(unittest.TestCase):
    ...
    def test_fauxware(self):
        ...
        project = bisa.Project(binary_path, main_opts=jni_options)
    ...
    def test_loading(self):
        ...
        project = bisa.Project(jar_path, main_opts=jni_options, auto_load_libs=True)
    ...
    def test_object_tracking(self):
        ...
        call_state.options.add(bisa.options.JAVA_IDENTIFY_GETTER_SETTER)
        call_state.options.add(bisa.options.JAVA_TRACK_ATTRIBUTES)
    ...
    def create_project(self, binary_dir, load_native_libs=True):
        ...
        if load_native_libs:
            ...
            project = bisa.Project(jar_path, main_opts=jni_options)
        else:
            project = bisa.Project(jar_path)
        return project
    ...
    def get_entry_state_of_method(self, project, method_fullname):
        ...
        # create call state
        return project.factory.blank_state(addr=addr, add_options={bisa.options.ZERO_FILL_UNCONSTRAINED_MEMORY})
