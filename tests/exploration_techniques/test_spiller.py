...
from bisa.exploration_techniques.spiller import Spiller
import bisa
...
class TestSpiller(unittest.TestCase):
    ...
    def test_basic(self):
        project = bisa.Project(_bin("cgc", "sc2_0b32aa01_01"), auto_load_libs=False)
    ...
    def test_palindrome2(self):
        ...
        limiter = bisa.exploration_techniques.LengthLimiter(max_length=250)
