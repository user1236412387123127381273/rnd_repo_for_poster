...
class TestDrillerCore(unittest.TestCase):
    ...
    def test_cgc(self):
        ...
        simgr.use_technique(bisa.exploration_techniques.DrillerCore(tracer._trace))
        simgr.run()
