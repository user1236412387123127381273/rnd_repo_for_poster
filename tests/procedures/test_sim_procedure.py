...
class TestSimProcedure(unittest.TestCase):
    def test_ret_float(self):
        class F1(bisa.SimProcedure):
            def run(self, *args, **kwargs):  # pylint: disable=unused-argument
                return 12.5

        p = bisa.load_shellcode(b"X", arch="i386")
    ...
    def test_syscall_and_simprocedure(self):
        ...
        proj.hook(0x80480A0, bisa.SIM_PROCEDURES["libc"]["puts"]())
    ...
    def test_inet_ntoa(self) -> None:
        ...
        proj = bisa.Project(bin_path, auto_load_libs=False, use_sim_procedures=True)
