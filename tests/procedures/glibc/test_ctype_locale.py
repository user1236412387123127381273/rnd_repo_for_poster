...
class TestCtypeLocale(unittest.TestCase):
    ...
    def test_ctype_b_loc(self):
        ...
        def ctype_b_loc(state, arguments):
            return bisa.SIM_PROCEDURES["glibc"]["__ctype_b_loc"]().execute(state, arguments=arguments)

        b = bisa.Project(bin_path, auto_load_libs=False)
    ...
    def test_ctype_tolower_loc(self):
        ...
        def ctype_tolower_loc(state, arguments):
            return bisa.SIM_PROCEDURES["glibc"]["__ctype_tolower_loc"]().execute(state, arguments=arguments)
    ...
    def test_ctype_toupper_loc(self):
        ...
        def ctype_toupper_loc(state, arguments):
            return bisa.SIM_PROCEDURES["glibc"]["__ctype_toupper_loc"]().execute(state, arguments=arguments)
