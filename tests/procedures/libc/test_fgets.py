...
class TestFgets(unittest.TestCase):
    ...
    def setUp(self):
        self.p = bisa.Project(TestFgets.TARGET_APP, auto_load_libs=False)
    ...
    def _testfind(self, addr, failmsg):
        ...
        e.options.add(bisa.sim_options.SHORT_READS)
        e.options.add(bisa.sim_options.SYMBOL_FILL_UNCONSTRAINED_MEMORY)
