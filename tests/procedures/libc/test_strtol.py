...
class TestStrtol(unittest.TestCase):
    ...
    def test_strtol(self, threads=None):
        ...
        b = bisa.Project(test_bin, auto_load_libs=True)

        initial_state = b.factory.entry_state(remove_options={bisa.options.LAZY_SOLVES})
