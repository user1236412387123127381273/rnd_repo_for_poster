...
import bisa
from bisa.procedures.definitions.win32_user32 import lib
from bisa.sim_type import SimTypeFunction, SimTypeInt, SimTypePointer, SimTypeChar
from bisa.engines.successors import SimSuccessors
from bisa.calling_conventions import SimCCStdcall, SimStackArg
...
class TestStubProcedureArgs(unittest.TestCase):
    def test_stub_procedure_args(self):
        ...
        proj = bisa.Project(os.path.join(test_location, "i386", "all"), auto_load_libs=False)
