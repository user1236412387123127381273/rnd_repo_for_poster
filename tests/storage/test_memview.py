...
from bisa.sim_type import register_types, parse_types, SimStruct, SimTypeNumOffset
...
class TestMemView(unittest.TestCase):
    ...
    def test_struct_bitfield_complex(self):
        bitfield_struct2 = bisa.types.parse_type(
        ...
        bisa.types.register_types(bitfield_struct2)
        state = SimState(arch="AMD64")
