...
from bisa.knowledge_plugins.variables import VariableType
...
if __name__ == "__main__":
    ...
    logging.getLogger("bisa.analyses.variable_recovery_fast").setLevel(logging.DEBUG)
    logging.getLogger("bisa.analyses.variable_recovery").setLevel(logging.DEBUG)
