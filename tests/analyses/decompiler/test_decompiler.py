...
from bisa.analyses.complete_calling_conventions import CallingConventionAnalysisMode
from bisa.analyses.decompiler import DECOMPILATION_PRESETS
from bisa.analyses.decompiler.optimization_passes.expr_op_swapper import OpDescriptor
from bisa.analyses.decompiler.optimization_passes import (
    DUPLICATING_OPTS,
    CONDENSING_OPTS,
...
from bisa.analyses.decompiler.decompilation_options import get_structurer_option, PARAM_TO_OPTION
from bisa.analyses.decompiler.structuring import STRUCTURER_CLASSES, PhoenixStructurer, SAILRStructurer
from bisa.analyses.decompiler.structuring.phoenix import MultiStmtExprMode
from bisa.sim_variable import SimStackVariable
from bisa.misc.testing import is_testing
from bisa.utils.library import convert_cproto_to_py
...
def set_decompiler_option(decompiler_options: list[tuple] | None, params: list[tuple]) -> list[tuple]:
    ...
    for param, value in params:
        for option in bisa.analyses.decompiler.decompilation_options.options:
...
def for_all_structuring_algos(func):
    ...
    bisa.analyses.Decompiler(f, cfg=..., options=decompiler_options)
    """
...
class TestDecompiler(unittest.TestCase):
    ...
    def test_decompiling_all_x86_64(self, decompiler_options=None):
        ...
        p = bisa.Project(bin_path, auto_load_libs=False, load_debug_info=True)
    ...
    def test_decompiling_aes_armel(self, decompiler_options=None):
        ...
        p = bisa.Project(bin_path, arch="ARMEL", auto_load_libs=False, load_debug_info=True)
    ...
    def test_decompiling_true_x86_64_1(self, decompiler_options=None):
        ...
        # constant propagation was failing. see https://github.com/bisa/bisa/issues/2659
        assert (
            code.count("32 <=") == 0
            and code.count("32 >") == 0
    ...
    def test_decompiling_true_mips64(self, decompiler_options=None):
        ...
        p = bisa.Project(bin_path, auto_load_libs=False, load_debug_info=False)
        cfg = p.analyses[CFGFast].prep()(normalize=True, data_references=True)
    ...
    def test_decompiling_strings_c_representation(self):
        ...
        for _input, expected in input_expected:
            result = bisa.analyses.decompiler.structured_codegen.c.CConstant.str_to_c_str(_input)
    ...
    def test_decompilation_call_expr_folding(self, decompiler_options=None):
        ...
        opt = next(
            o for o in bisa.analyses.decompiler.decompilation_options.options if o.param == "remove_dead_memdefs"
        )
    ...
    def test_simple_strcpy(self, decompiler_options=None):
        ...
        assert isinstance(dw, bisa.analyses.decompiler.structured_codegen.c.CDoWhileLoop)
    ...
    @unittest.skip("Disabled until https://github.com/bisa/bisa/issues/4406 fixed")
    @for_all_structuring_algos
    def test_decompiling_x8664_cvs(self, decompiler_options=None):
        # TODO: this is broken, but not shown in CI b/c slow, and tracked by https://github.com/bisa/bisa/issues/4406
    ...
    def test_struct_access(self, decompiler_options=None):
        ...
        typedefs = bisa.types.parse_file(
            """
        struct A {
            int a1;
            int a2;
    ...
    def test_decompiling_functions_with_unknown_simprocedures(self, decompiler_options=None):
        # bisa does not have function signatures for cgc_allocate (and other cgc_*) functions, which means we will never
    ...
    def test_reverting_switch_lowering_filename_unescape(self, decompiler_options=None):
        ...
        #  Fix in: https://github.com/bisa/bisa/issues/4252
        # assert "goto" not in d.codegen.text
        # TODO: the following check requires bisa decompiler to implement assignment de-duplication
        # assert d.codegen.text.count("case 110:") == 1
        # TODO: the following check requires bisa decompiler correctly support rewriting gotos inside nested loops and
    ...
    def test_sensitive_eager_returns(self, decompiler_options=None):
        ...
        all_optimization_passes = [
            ...
            if p is not bisa.analyses.decompiler.optimization_passes.CrossJumpReverter
        ]
        d = proj.analyses[Decompiler](
    ...
    def test_ifelsesimplifier_insert_node_into_while_body(self, decompiler_options=None):
        # https://github.com/bisa/bisa/issues/4082

        bin_path = os.path.join(test_location, "x86_64", "decompiler", "bisa_4082_cache")
        proj = bisa.Project(bin_path, auto_load_libs=False)
        cfg = proj.analyses.CFGFast(normalize=True, data_references=True)
    ...
    def test_automatic_ternary_creation_1(self, decompiler_options=None):
        ...
        """
        # https://github.com/bisa/bisa/issues/4050
    ...
    @unittest.skip("Disabled until https://github.com/bisa/bisa/issues/4474 fixed")
    @for_all_structuring_algos
    ...
    def test_ite_region_converter_missing_break_statement(self, decompiler_options=None):
        # https://github.com/bisa/bisa/issues/4574
    ...
    def test_ternary_expression_over_propagation(self, decompiler_options=None):
        # https://github.com/bisa/bisa/issues/4573
        bin_path = os.path.join(test_location, "x86_64", "ite_region_converter_missing_breaks")
        proj = bisa.Project(bin_path, auto_load_libs=False)
        cfg = proj.analyses.CFGFast(normalize=True, data_references=True)
        f = proj.kb.functions["authenticate"]
    ...
    def test_inlining_shallow(self):
        ...
        d = proj.analyses[Decompiler].prep(fail_fast=True)(
            ...
            options=[(bisa.analyses.decompiler.decompilation_options.options[0], True)],
        )
        self._print_decompilation_result(d)
    ...
    def test_deterministic_sorting_c_variables(self, decompiler_options=None):
        # https://github.com/bisa/bisa/issues/4746
    ...
    def test_sailr_motivating_example(self, decompiler_options=None):
        ...
        # https://github.com/bisa/binaries/blob/bdf9ba7c4013e5d8706a16ed79ef29ee776492a1/tests_src/decompiler/sailr_motivating_example.c#L44
    ...
    def test_decompiling_ite_function_arguments_missing_assignments(self, decompiler_options=None):
        # https://github.com/bisa/bisa/issues/5077
