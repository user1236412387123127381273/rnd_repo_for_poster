...
import bisa
import bisa.analyses.decompiler
from bisa.analyses import Decompiler
from bisa.analyses.decompiler.structuring import DreamStructurer
...
class TestStructurer(unittest.TestCase):
    def test_region_identifier_0(self):
        ...
        ri = bisa.analyses.decompiler.RegionIdentifier(None, graph=g)
        region = ri.region
    ...
    def test_smoketest(self):
        p = bisa.Project(os.path.join(test_location, "x86_64", "all"), auto_load_libs=False, load_debug_info=True)
