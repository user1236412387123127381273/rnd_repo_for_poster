...
class TestDogboltRegressions(unittest.TestCase):
    ...
    def _run_dogbolt_test(self, binary_name: str):
        p = bisa.Project(os.path.join(BIN_PATH, binary_name), auto_load_libs=False, load_debug_info=False)
    ...
    def test_megatest_arm64_freebsd(self):
        ...
        and bisa verstion 9.2.122 would time out when decompiling the __start
