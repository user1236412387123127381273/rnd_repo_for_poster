...
import bisa
from bisa.analyses.decompiler.peephole_optimizations import ConstantDereferences, EagerEvaluation
...
class TestPeepholeOptimizations(unittest.TestCase):
    def test_constant_dereference(self):
        ...
        proj = bisa.Project(os.path.join(test_location, "armel", "decompiler", "rm"), auto_load_libs=False)
    ...
    def test_eager_eval_mod(self):
        proj = bisa.load_shellcode(b"\x90", "AMD64")
