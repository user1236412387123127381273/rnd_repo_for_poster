...
from bisa.sim_type import SimTypeFunction, SimTypeInt, SimTypeLongLong, SimTypeBottom, SimTypeFloat
...
class TestCallingConventionAnalysis(unittest.TestCase):
    def _run_fauxware(self, arch, function_and_cc_list):
        ...
        fauxware = bisa.Project(binary_path, auto_load_libs=False)
    ...
    def test_x8664_dir_gcc_O0(self, *, mode):
        ...
        proj = bisa.Project(binary_path, auto_load_libs=False, load_debug_info=False)
    ...
    def test_armel_fauxware(self, *, mode):
        ...
        expected_args = {
            ...
            # hardcoded in bisa. the third arg is still "live" from the function start.
        }
...
if __name__ == "__main__":
    # logging.getLogger("bisa.analyses.variable_recovery.variable_recovery_fast").setLevel(logging.DEBUG)
    logging.getLogger("bisa.analyses.calling_convention").setLevel(logging.INFO)
    unittest.main()
