...
from bisa.analyses.cfg.indirect_jump_resolvers import JumpTableResolver
...
l = logging.getLogger("bisa.tests.test_jumptables")
...
class TestJumpTableResolver(unittest.TestCase):
    ...
    def test_amd64_hostname_gcc_O2(self):
        p = bisa.Project(os.path.join(test_location, "x86_64", "hostname"), auto_load_libs=False)
        cfg = p.analyses.CFGFast()
    ...
    def test_amd64_cfgswitches_gcc(self):
        p = bisa.Project(os.path.join(test_location, "x86_64", "cfg_switches"), auto_load_libs=False)
        cfg = p.analyses.CFGFast()
    ...
    def test_i386_cfgswitches_gcc_O0(self):
        p = bisa.Project(os.path.join(test_location, "i386", "cfg_switches_O0"), auto_load_libs=False)
        cfg = p.analyses.CFGFast()
    ...
    def test_i386_cfgswitches_gcc_O1(self):
        p = bisa.Project(os.path.join(test_location, "i386", "cfg_switches_O1"), auto_load_libs=False)
        cfg = p.analyses.CFGFast()
    ...
    def test_i386_cfgswitches_gcc_O2(self):
        p = bisa.Project(os.path.join(test_location, "i386", "cfg_switches_O2"), auto_load_libs=False)
        cfg = p.analyses.CFGFast()
    ...
    def test_kprca_00009(self):
        p = bisa.Project(os.path.join(test_location, "cgc", "KPRCA_00009"), auto_load_libs=False)
        cfg = p.analyses.CFGFast()
    ...
    def test_armel_cfgswitches_gcc(self):
        p = bisa.Project(os.path.join(test_location, "armel", "cfg_switches"), auto_load_libs=False)
        cfg = p.analyses.CFGFast()
    ...
    def test_armel_lwip_tcpecho_bm(self):
        p = bisa.Project(os.path.join(test_location, "armel", "lwip_tcpecho_bm.elf"), auto_load_libs=False)
        cfg = p.analyses.CFGFast()
    ...
    def test_s390x_cfgswitches(self):
        p = bisa.Project(os.path.join(test_location, "s390x", "cfg_switches"), auto_load_libs=False)
        cfg = p.analyses.CFGFast()
    ...
    def test_arm_libsoap(self):
        ...
        p = bisa.Project(os.path.join(test_location, "armel", "libsoap.so"), auto_load_libs=False)
    ...
    def test_jumptable_occupied_as_data(self):
        ...
        p = bisa.Project(os.path.join(test_location, "i386", "windows", "printenv.exe"), auto_load_libs=False)
        cfg = p.analyses.CFGFast()
    ...
    def test_mips_jumptable0(self):
        p = bisa.Project(os.path.join(test_location, "mipsel", "jumptable_0"), auto_load_libs=False)
    ...
    def test_amd64_fmt0_with_constant_propagation_r12(self):
        p = bisa.Project(os.path.join(test_location, "x86_64", "fmt_0"), auto_load_libs=False)
        cfg = p.analyses[CFGFast].prep()()
    ...
    def test_amd64_win_jumptable_with_secondary_redirections(self):
        p = bisa.Project(os.path.join(test_location, "x86_64", "windows", "WinDivert.sys"), auto_load_libs=False)
        cfg = p.analyses[CFGFast].prep()()
    ...
    def test_arm_thumb_jumptable_multi_variable_ranges(self):
        ...
        proj = bisa.Project(os.path.join(test_location, "armhf", "AP_GPS_NMEA.cpp.0.o"), auto_load_libs=False)
...
class TestJumpTableResolverCallTables(unittest.TestCase):
    ...
    @staticmethod
    def _make_call_graph_edge_set_by_name(proj: bisa.Project, src: str, dsts: set[str]):
        """
