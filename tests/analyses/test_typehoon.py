...
import bisa
from bisa.sim_type import SimTypeFloat
from bisa.analyses.typehoon.typevars import (
    TypeVariable,
    DerivedTypeVariable,
    Subtype,
    FuncIn,
...
from bisa.analyses.typehoon.typeconsts import Int32, Struct, Pointer64, Float32, Float64
from bisa.analyses.typehoon.translator import TypeTranslator
...
class TestTypehoon(unittest.TestCase):
    def test_smoketest(self):
        p = bisa.Project(os.path.join(test_location, "x86_64", "linked_list"), auto_load_libs=False)
    ...
    def test_type_inference_byte_pointer_cast(self):
        proj = bisa.Project(os.path.join(test_location, "i386", "type_inference_1"), auto_load_libs=False)
    ...
    def test_function_call_argument_type_propagation(self):
        ...
        proj = bisa.Project(os.path.join(test_location, "x86_64", "windows", "sioctl.sys"), auto_load_libs=False)
    ...
    def test_type_inference_basic_case_0(self):
        ...
        proj = bisa.load_shellcode(b"\x90\x90", "AMD64")
