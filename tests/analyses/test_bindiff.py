...
l = logging.getLogger("bisa.tests.test_bindiff")
...
class TestBindiff(unittest.TestCase):
    def test_bindiff_x86_64(self):
        ...
        b = bisa.Project(binary_path_1, load_options={"auto_load_libs": False})
        b2 = bisa.Project(binary_path_2, load_options={"auto_load_libs": False})
