...
class TestSlicing(unittest.TestCase):
    ...
    def test_backward_slice(self):
        ...
        cfg = slicing_test.analyses.CFGEmulated(
            context_sensitivity_level=2, keep_state=True, state_add_options=bisa.sim_options.refs
        )
    ...
    def test_fauxware(self):
        b = bisa.Project(os.path.join(test_location, "x86_64", "fauxware"), auto_load_libs=False)
        cfg = b.analyses.CFGEmulated(
            keep_state=True, state_add_options=bisa.sim_options.refs, context_sensitivity_level=2
        )
