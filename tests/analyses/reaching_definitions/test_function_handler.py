...
import bisa
from bisa.analyses.reaching_definitions import FunctionHandler
...
if TYPE_CHECKING:
    ...
    from bisa.analyses.reaching_definitions import FunctionCallData
...
class TestFunctionHandler(TestCase):
    def test_function_handler_depends_has_endness(self):
        ...
        project = bisa.Project(filename, auto_load_libs=False)
