...
class TestWindowsArgs(unittest.TestCase):
    def test_i386(self):
        ...
        p = bisa.Project(os.path.join(test_location, "i386", "simple_windows.exe"), auto_load_libs=False)

        s = p.factory.entry_state(args=("simple_windows.exe", "bisa_can_windows?", "1497715489"))
...
if __name__ == "__main__":
    logging.getLogger("bisa.engines").setLevel("INFO")
    unittest.main()
