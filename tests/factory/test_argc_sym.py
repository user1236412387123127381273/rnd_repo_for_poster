...
class TestArgcSym(unittest.TestCase):
    ...
    def test_mips(self):
        arger_mips = bisa.Project(os.path.join(test_location, "mips", "argc_symbol"), auto_load_libs=False)
    ...
    def test_mipsel(self):
        arger_mipsel = bisa.Project(os.path.join(test_location, "mipsel", "argc_symbol"), auto_load_libs=False)
        r_addr = [0x400720, 0x40076C, 0x4007BC]
    ...
    def test_i386(self):
        arger_i386 = bisa.Project(os.path.join(test_location, "i386", "argc_symbol"), auto_load_libs=False)
    ...
    def test_arm(self):
        arger_arm = bisa.Project(os.path.join(test_location, "armel", "argc_symbol"), auto_load_libs=False)
    ...
    def test_ppc32(self):
        arger_ppc32 = bisa.Project(os.path.join(test_location, "ppc", "argc_symbol"), auto_load_libs=False)
