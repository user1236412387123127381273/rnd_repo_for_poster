...
def internaltest_project(fpath):
    ...
    p = bisa.Project(tpath, auto_load_libs=False)
...
class TestSerialization(unittest.TestCase):
    def test_analyses(self):
        p = bisa.Project(os.path.join(test_location, "i386", "fauxware"), load_options={"auto_load_libs": False})
        cfg = p.analyses.CFG()
