...
from .errors import BISANoPluginError
...
class Project:
    """
    This is the main class of the bisa module. It is meant to contain a set of binaries and the relationships between
    ...
    :ivar factory:      Provides access to important analysis elements such as path groups and symbolic execution
                        results.
    :type factory:      BISAObjectFactory
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if isinstance(thing, cle.Loader):
            if load_options:
                l.warning("You provided CLE options to bisa but you also provided a completed cle.Loader object!")
            self.loader = thing
            ...
            # use bisa's loader, provided by cle
        ...
        # Step 5.1 Factory
        self.factory = BISAObjectFactory(self, default_engine=engine)
    ...
    def _register_object(self, obj, sim_proc_arch):
        ...
        for reloc in obj.imports.values():
            ...
            if func.resolvedby is None:
                ...
                # good luck.
                # ref: https://github.com/bisa/bisa/issues/1782
    ...
    def hook(self, addr, hook=None, length=0, kwargs=None, replace: bool | None = False):
        ...
        Usage::
            ...
            # Assuming proj is an instance of bisa.Project, we will add a custom hook at the entry
        ...
        :param hook:        A :class:`bisa.project.Hook` describing a procedure to run at the
        ...
        #        hook,
        #    )
        #    l.error("Consider also using bisa.SIM_LIBRARIES instead of bisa.SIM_PROCEDURES or bisa.procedures.")
...
from .factory import BISAObjectFactory
