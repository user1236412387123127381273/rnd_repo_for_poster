...
class Spiller(ExplorationTechnique):
    ...
    def __init__(
        ...
        :param vault:        an bisa.Vault object to handle storing and loading of states. If not provided, an
                             bisa.vaults.VaultShelf will be created with a temporary file.
        """
        super().__init__()
        self.max = max
        self.min = min
