    ...
    *instance* of the technique.
    ...
    def __init__(self):
        ...
        if not hasattr(self, "project"):
            self.project: bisa.Project = None

    def setup(self, simgr):
        """
        Perform any initialization on this manager you might need to do.

        :param bisa.SimulationManager simgr:    The simulation manager to which you have just been added
        """
    ...
    def step(self, simgr, stash="active", **kwargs):  # pylint:disable=no-self-use
        ...
        :param bisa.SimulationManager simgr:
        :param str stash:
        """
