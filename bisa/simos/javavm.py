...
import bisa
from bisa import SIM_PROCEDURES, options
from bisa.calling_conventions import default_cc, SimCCSoot
from bisa.engines.soot import SootMixin
from bisa.engines.soot.expressions import SimSootExpr_NewArray
from bisa.engines.soot.values import (
    SimSootValue_ArrayRef,
    SimSootValue_StringRef,
    SimSootValue_ThisRef,
    SimSootValue_StaticFieldRef,
)
from bisa.errors import BISASimOSError
from bisa.procedures.java_jni import jni_functions
from bisa.sim_state import SimState
from bisa.sim_type import SimTypeFunction, SimTypeNum
from .simos import SimOS

l = logging.getLogger("bisa.simos.JavaVM")
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.is_javavm_with_jni_support:
            ...
            if len(self.native_libs) == 0:
                raise BISASimOSError("No JNI lib was loaded. Is the jni_libs_ld_path set correctly?")
            ...
            native_libs_simos = {bisa.simos.os_mapping[obj.os] for obj in self.native_libs}
            ...
            if native_libs_simos:
                ...
                raise BISASimOSError("Cannot instantiate SimOS for native libraries: No compatible SimOS found.")
