...
from bisa.utils.mp import Initializer
from bisa.exploration_techniques import ExplorationTechnique, Bucketizer
from bisa.vaults import VaultDirShelf
...
class Worker:
    ...
    def run(self, initializer: Initializer):
        ...
        from bisa.exploration_techniques.spiller import (
            Spiller,
            PickledStatesDb,
