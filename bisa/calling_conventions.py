...
import bisa
from .errors import BISATypeError
...
class SimCC:
    ...
    def get_arg_info(self, state, prototype):
        ...
        :param bisa.SimState state: The state to evaluate and extract the values from
...
class SimCCSoot(SimCC):
    ...
    def setup_callsite(self, state, ret_addr, args, prototype, stack_base=None, alloc_base=None, grow_like_stack=True):
        bisa.engines.SootMixin.setup_callsite(state, args, ret_addr)
