...
from bisa.engines.vex.light import VEXMixin
...
_make_wrapper(
    ...
    errors.UnsupportedDirtyError,
    "_check_unsupported_dirty",
    errors.SimOperationError,
    "_check_errored_dirty",
)
_make_wrapper(
    "_perform_vex_expr_CCall",
    errors.UnsupportedCCallError,
    "_check_unsupported_ccall",
    errors.SimOperationError,
    "_check_errored_ccall",
)
_make_wrapper(
    "_perform_vex_expr_Op",
    errors.SimZeroDivisionException,
    "_check_zero_division",
    errors.UnsupportedIROpError,
    "_check_unsupported_op",
)
