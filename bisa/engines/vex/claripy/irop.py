...
from bisa.errors import UnsupportedIROpError, SimOperationError, SimValueError, SimZeroDivisionException
...
class SimIROp:
    ...
    def _op_fgeneric_Cmp(self, args):  # pylint:disable=no-self-use
        # see https://github.com/bisa/vex/blob/master/pub/libvex_ir.h#L580
