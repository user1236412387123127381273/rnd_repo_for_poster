...
from bisa.engines.vex.claripy.irop import UnsupportedIROpError, SimOperationError, vexop_to_simop
from bisa.code_location import CodeLocation
from bisa.project import Project
from bisa.engines.engine import DataType_co, SimEngine, StateType
    ...
    def _process_block(self, whitelist: set[int] | None = None) -> ResultType:
        ...
        for stmt_idx, stmt in enumerate(self.block.vex.statements):
            ...
            if type(stmt) is pyvex.IRStmt.IMark:
                ...
                # The bug caused by skipping IMarks is reported at https://github.com/bisa/bisa/pull/1150
