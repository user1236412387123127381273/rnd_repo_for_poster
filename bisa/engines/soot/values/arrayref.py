...
l = logging.getLogger("bisa.engines.soot.values.arrayref")
...
class SimSootValue_ArrayRef(SimSootValue):
    ...
    @classmethod
    def from_sootvalue(cls, soot_value, state):
        base_local = bisa.engines.soot.values.translate_value(soot_value.base, state)
    ...
    def translate_array_index(idx, state):
        idx_value = bisa.engines.soot.values.translate_value(idx, state)
