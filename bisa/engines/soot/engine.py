...
from bisa.errors import SimEngineError, SimTranslationError
from cle import CLEError
from bisa.state_plugins.inspect import BP_AFTER, BP_BEFORE
from bisa.sim_type import SimTypeFunction, parse_type
from bisa.engines.successors import SuccessorsEngine
from bisa.engines.procedure import ProcedureMixin
...
l = logging.getLogger("bisa.engines.soot.engine")
...
class SootMixin(SuccessorsEngine, ProcedureMixin):
    ...
    def _get_sim_procedure(self, addr):
        # Delayed import
        from bisa.procedures import SIM_PROCEDURES
    ...
    def get_unconstrained_simprocedure(self):
        ...
        procedure_cls = SIM_PROCEDURES["bisa.unconstrained"]["unconstrained()"]
