...
if TYPE_CHECKING:
    ...
    from bisa.simos.javavm import SimJavaVM
...
class SimState(Generic[IPTypeConc, IPTypeSym], PluginHub[SimStatePlugin]):
    ...
    :ivar mem:          A convenient view of the state's memory, a :class:`bisa.state_plugins.view.SimMemView`
    ...
    :ivar inspect:      The breakpoint manager, a :class:`bisa.state_plugins.inspect.SimInspector`
    ...
    def step(self, **kwargs):
        ...
        Any arguments to `BISAObjectFactory.successors` can be passed to this.
    ...
    def block(self, *args, **kwargs):
        ...
        Any arguments to `BISAObjectFactory.block` can ba passed to this.
