...
from bisa.errors import SimMergeError
...
class SimFilesystem(SimStatePlugin):  # pretends links don't exist
    """
    bisa's emulated filesystem. Available as state.fs.
...
class SimMount(SimStatePlugin):
    """
    This is the base class for "mount points" in bisa's simulated filesystem. Subclass this class and
