...
from bisa.errors import SimPosixError, SimSolverError, SimMergeError, SimMemoryError
from bisa.sim_state import SimState
from bisa.storage.file import SimFile, SimPacketsStream, Flags, SimFileDescriptor, SimFileDescriptorDuplex
...
class SimSystemPosix(SimStatePlugin):
    ...
    def _get_concrete_fd(self, fd, create_file):
        ...
        new_filename = b"/tmp/bisa_implicit_%d" % self.autotmp_counter
