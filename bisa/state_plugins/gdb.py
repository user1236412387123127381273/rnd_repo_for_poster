...
from bisa.errors import SimStateError
...
class GDB(SimStatePlugin):
    ...
    def set_regs(self, regs_dump):
        ...
        for r in rdata:
            ...
            # Some registers such as cs, ds, eflags etc. aren't supported in bisa
    ...
    def _adjust_regs(self):
        """
        Adjust bp and sp w.r.t. stack difference between GDB session and bisa.
