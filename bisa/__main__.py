...
from bisa.analyses.decompiler.structuring import STRUCTURER_CLASSES, DEFAULT_STRUCTURER
from bisa.analyses.decompiler.utils import decompile_functions
...
def parse_function_args(proj: bisa.Project, func_args: list[str] | None) -> Generator[Function]:
    """
...
def disassemble(args):
    ...
    proj = bisa.Project(args.binary, auto_load_libs=False, main_opts=loader_main_opts_kwargs)
...
def main():
    parser = argparse.ArgumentParser(description="The bisa CLI allows you to decompile and analyze binaries.")
