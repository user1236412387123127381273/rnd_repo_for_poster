...
for pkg_name, package in autoimport.auto_import_packages("bisa.procedures", path, skip_dirs):
...
class _SimProcedures:
    def __getitem__(self, k):
        l.critical(
            "the SimProcedures dictionary is DEPRECATED. Please use the bisa.SIM_PROCEDURES global dict instead."
        )
