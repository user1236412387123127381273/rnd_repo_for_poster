...
class __libc_start_main(bisa.SimProcedure):
    ...
    def static_exits(self, blocks, cfg=None, **kwargs):
        ...
        ty = bisa.sim_type.parse_signature("void x(void*, void*, void*, void*, void*)").with_arch(self.arch)
    ...
    def _extract_args(state, main, argc, argv, init, fini):
        ...
        :param bisa.sim_state.SimState state: The program state.
