...
from bisa.errors import SimProcedureArgumentError, SimProcedureError, SimSolverError
from bisa import sim_type
from bisa.sim_procedure import SimProcedure
from bisa.storage.file import SimPackets
...
class FormatParser(SimProcedure):
    ...
    def _sim_atoi_inner(self, str_addr, region, base=10, read_length=None):
        ...
        from bisa.procedures import SIM_PROCEDURES  # pylint:disable=import-outside-toplevel
