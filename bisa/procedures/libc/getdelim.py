...
class __getdelim(bisa.SimProcedure):
    ...
    def run(self, line_ptrptr, len_ptr, delim, file_ptr):
        ...
        if delim.symbolic:
            raise bisa.SimProcedureError("I don't know how to handle a symbolic delimiter")
        ...
        if simfd.read_storage.concrete:
            ...
            realloc = bisa.SIM_PROCEDURES["libc"]["realloc"]
