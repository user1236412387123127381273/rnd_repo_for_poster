...
import bisa
from bisa.errors import SimSolverError


class fseek(bisa.SimProcedure):
    ...
    def run(self, file_ptr, offset, whence):
        ...
        try:
            ...
            raise bisa.SimProcedureError('multi-valued "whence" is not supported in fseek.') from err
