...
import bisa
from bisa.storage.memory_mixins.address_concretization_mixin import MultiwriteAnnotation
...
class strchr(bisa.SimProcedure):
    # pylint:disable=arguments-differ

    def run(self, s_addr, c_int, s_strlen=None):
        c = c_int[7:0]
        s_strlen = self.inline_call(bisa.SIM_PROCEDURES["libc"]["strlen"], s_addr)
