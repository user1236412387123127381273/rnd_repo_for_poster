...
class _kuser_helper_version(bisa.SimProcedure):
...
class _kuser_helper_get_tls(bisa.SimProcedure):
    # pylint: disable=arguments-differ
...
class _kuser_cmpxchg(bisa.SimProcedure):
    # pylint: disable=arguments-differ
...
class _kuser_memory_barrier(bisa.SimProcedure):
    # pylint: disable=arguments-differ
...
class _kuser_cmpxchg64(bisa.SimProcedure):
    # pylint: disable=arguments-differ
