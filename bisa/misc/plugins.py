...
from bisa.errors import BISANoPluginError
...
class PluginHub(Generic[P]):
    ...
    Objects in bisa like the SimState, the Analyses hub, the SimEngine selector, etc all use this
    ...
    def __getattr__(self, name: str) -> P:
        ...
        except BISANoPluginError as err:
    ...
    def use_plugin_preset(self, preset):
        ...
        if isinstance(preset, str):
            try:
                ...
                raise BISANoPluginError(f"There is no preset named {preset}") from err
    ...
    def get_plugin(self, name: str) -> P:
        ...
        raise BISANoPluginError(f"No such plugin: {name}")
...
class PluginPreset:
    ...
    def request_plugin(self, name: str) -> type[P]:
        ...
        try:
            ...
            raise BISANoPluginError(f"There is no plugin named {name}") from err
