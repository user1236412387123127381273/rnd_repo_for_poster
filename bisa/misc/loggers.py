...
from bisa.utils.formatting import ansi_color_enabled


class Loggers:
    """
    Implements a loggers manager for bisa.
    """
    ...
    IN_SCOPE = ("bisa", "claripy", "cle", "pyvex", "archinfo", "tracer", "driller", "rex", "patcherex", "identifier")
    ...
    def enable_root_logger(self):
        """
        Enable bisa's default logger
        """
        logging.root.addHandler(self.handler)

    def disable_root_logger(self):
        """
        Disable bisa's default logger
        """
