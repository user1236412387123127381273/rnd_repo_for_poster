...
from .errors import BISAVaultError
from .project import Project
from .sim_state import SimState
from .sim_type import SimType

l = logging.getLogger("bisa.vault")
...
class Vault(collections.abc.MutableMapping):
    """
    The vault is a serializer for bisa.
    """
    ...
    def __init__(self):
        ...
        self.module_dedup = set()  # {'claripy', 'bisa', 'archinfo', 'pyvex' } # cle causes recursion
    ...
    def is_stored(self, i):
        ...
        try:
            with self._read_context(i):
                return True
        except (BISAVaultError, EOFError):
            return False
    ...
    def __delitem__(self, k):
        raise BISAVaultError("We currently don't support deletion from the vault.")
