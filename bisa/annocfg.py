...
from .errors import BISAAnnotatedCFGError, BISAExitError
...
class AnnotatedCFG:
    ...
    def __init__(self, project, cfg=None, detect_loops=False):
        ...
        :param project: The bisa Project instance
    ...
    def get_addr(self, run):
        ...
        if type(run) is int:
            return run
        raise BISAAnnotatedCFGError(f"Unknown type '{type(run)}' of the 'run' argument")
