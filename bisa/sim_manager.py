...
from .errors import BISAError, SimUnsatError, SimulationManagerError
...
class SimulationManager:
    ...
    creating them in ``Project.factory``: see :class:`bisa.factory.BISAObjectFactory`.

    The most important methods you should look at are ``step``, ``explore``, and ``use_technique``.

    :param project:         A Project instance.
    :type project:          bisa.project.Project
    ...
    :param resilience:      A set of errors to catch during stepping to put a state in the ``errore`` list.
                            ...
                            no errors, all bisa-specific errors, and a set of many common errors.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if resilience is None:
            self._resilience = (BISAError, SimError, claripy.ClaripyError)
    ...
    def use_technique(self, tech):
        ...
        Techniques can be found in :mod:`bisa.exploration_techniques`.
    ...
    def explore(
        ...
        **kwargs,
        ...
        If an bisa CFG is passed in as the "cfg" parameter and "find" is either a number or a list or a set, then
