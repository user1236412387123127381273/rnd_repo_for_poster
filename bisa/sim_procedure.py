...
from bisa.errors import SimProcedureError, SimShadowStackError
from bisa.state_plugins.sim_action import SimActionExit
...
class SimProcedure:
    ...
    A detailed discussion of programming SimProcedures may be found at https://docs.angr.io/extending-bisa/simprocedures
    ...
    :ivar project:          The associated bisa project
