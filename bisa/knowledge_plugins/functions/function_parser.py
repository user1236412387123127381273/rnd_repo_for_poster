...
from bisa.utils.enums_conv import func_edge_type_to_pb, func_edge_type_from_pb
from bisa.protos import primitives_pb2, function_pb2
...
class FunctionParser:
    ...
    def _get_block_or_func(addr, blocks, external_addrs, function_manager, project, all_func_addrs=None):
        ...
        raise ValueError(
            ...
            "This probably indicates a bug in bisadb generation."
        )
