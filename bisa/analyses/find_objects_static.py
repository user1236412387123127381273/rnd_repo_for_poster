...
from bisa.analyses.reaching_definitions.function_handler import FunctionHandler
...
if TYPE_CHECKING:
    from bisa.analyses.reaching_definitions.function_handler import FunctionCallData
