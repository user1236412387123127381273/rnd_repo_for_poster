...
from bisa.analyses import Analysis, AnalysesHub
from bisa.errors import SimMemoryMissingError, BISACallableMultistateError, BISACallableError, BISAAnalysisError
from bisa.calling_conventions import SimRegArg, default_cc
from bisa.state_plugins.sim_action import SimActionData
from bisa.sim_options import ZERO_FILL_UNCONSTRAINED_REGISTERS, ZERO_FILL_UNCONSTRAINED_MEMORY, TRACK_MEMORY_ACTIONS
from bisa.sim_type import SimTypeFunction, SimTypeBottom, SimTypePointer
from bisa.analyses.reaching_definitions import ObservationPointType
...
class StringObfuscationFinder(Analysis):
    ...
    def _find_type1(self) -> list[tuple[int, StringDeobFuncDescriptor]]:
        ...
        if cfg is None:
            raise BISAAnalysisError("StringObfuscationFinder needs a CFG for the analysis")
        ...
        for func in self.project.kb.functions.values():
            ...
            for args in args_list:
                ...
                except (BISACallableMultistateError, BISACallableError):
                    continue
    ...
    def _find_type3(self) -> list[tuple[int, StringDeobFuncDescriptor]]:
        ...
        # - The entire call can be simulated (it does not involve any other functions that bisa does not support or do
