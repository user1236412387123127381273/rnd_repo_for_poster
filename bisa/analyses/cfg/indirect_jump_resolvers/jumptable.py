...
from bisa import BP, BP_BEFORE, BP_AFTER
from bisa.misc.ux import once
from bisa.concretization_strategies import SimConcretizationStrategyAny
from bisa.knowledge_plugins.cfg import IndirectJump, IndirectJumpType
from bisa.engines.vex.claripy import ccall
from bisa.engines.light import SimEngineNostmtVEX, SpOffset, RegisterOffset
from bisa.errors import BISAError, SimError
from bisa.blade import Blade
from bisa.annocfg import AnnotatedCFG
from bisa.exploration_techniques.slicecutor import Slicecutor
from bisa.exploration_techniques.local_loop_seer import LocalLoopSeer
from bisa.exploration_techniques.explorer import Explorer
from bisa.utils.constants import DEFAULT_STATEMENT
from bisa.analyses.propagator.top_checker_mixin import ClaripyDataVEXEngineMixin
from bisa.engines.vex.claripy.datalayer import value
...
class NotAJumpTableNotification(BISAError):
    """
    ...
    def _jumptable_precheck(self, b, indirect_jump_node_pred_addrs):
        ...
        for src in sources:
            ...
            while src is not None:
                ...
                except (claripy.ClaripyError, SimError, BISAError):
                    # anything can happen
                    break
    ...
    def _try_resolve_targets_load(
        ...
        if stmts_adding_base_addr:
            if len(stmts_adding_base_addr) == 1:
                ...
                #
                # the proper solution requires bisa to correctly determine that esi is the beginning address of the data
