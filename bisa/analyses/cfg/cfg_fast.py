...
from bisa.knowledge_plugins.cfg import CFGNode, MemoryDataSort, MemoryData, IndirectJump, IndirectJumpType
from bisa.knowledge_plugins.xrefs import XRef, XRefType
from bisa.knowledge_plugins.functions import Function
from bisa.codenode import HookNode
...
if TYPE_CHECKING:
    ...
    from bisa.engines.pcode.lifter import IRSB as PcodeIRSB
...
class PendingJobs:
    ...
    def pop_job(self, returning=True):
        ...
        :rtype: bisa.analyses.cfg.cfg_fast.CFGJob
        """
...
class CFGFast(ForwardAnalysis[CFGNode, CFGNode, CFGJob, int], CFGBase):  # pylint: disable=abstract-method
    ...
    def __init__(
        ...
        **extra_arch_options,
        ...
        :param check_funcret_max_job    When popping return-site jobs out of the job queue, bisa will prioritize jobs
        ...
        Extra parameters that bisa.Analysis takes:
    ...
    def _function_completed(self, func_addr: int):
        ...
        if self._collect_data_ref and self.project is not None and ":" in self.project.arch.name:
            ...
            from bisa.analyses.decompiler.clinic import ClinicMode  # pylint:disable=wrong-import-position
    ...
    def _create_jobs(
        ...
        if target_addr in self._known_thunks and jumpkind == "Ijk_Boring":
            ...
            if thunk_kind == "ret":
                ...
                raise BISACFGError("This shouldn't be possible")
    ...
    def _function_add_fakeret_edge(self, addr, src_node, src_func_addr, confirmed=None):
        ...
        :param bisa.analyses.CFGNode src_node: source node
