...
from bisa import BP, BP_AFTER
from bisa.sim_variable import SimRegisterVariable, SimStackVariable
...
class VariableRecoveryState(VariableRecoveryStateBase):
    ...
    :ivar bisa.knowledge.variable_manager.VariableManager variable_manager: The variable manager.
    """
...
class VariableRecovery(ForwardAnalysis, VariableRecoveryBase):  # pylint:disable=abstract-method
    ...
    def _run_on_node(self, node, state):
        ...
        :param bisa.Block node:             The node to work on.
