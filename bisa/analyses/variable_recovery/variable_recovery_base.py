...
from bisa.utils.cowdict import DefaultChainMapCOW
...
from bisa.analyses.typehoon.typevars import TypeVariables, TypeVariable

if TYPE_CHECKING:
    from bisa.storage import SimMemoryObject
...
class VariableRecoveryStateBase:
    ...
    def stack_addr_from_offset(self, offset: int) -> int:
        if self.arch.bits == 32:
            ...
            raise BISARuntimeError(f"Unsupported bits {self.arch.bits}")
