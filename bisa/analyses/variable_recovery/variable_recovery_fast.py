...
import bisa.errors
from bisa import SIM_TYPE_COLLECTIONS
from bisa.analyses import AnalysesHub
from bisa.storage.memory_mixins.paged_memory.pages.multi_values import MultiValues
from bisa.block import Block
from bisa.errors import BISAVariableRecoveryError, SimEngineError
from bisa.knowledge_plugins import Function
from bisa.knowledge_plugins.key_definitions import atoms
from bisa.sim_variable import SimStackVariable, SimRegisterVariable, SimVariable, SimMemoryVariable
from bisa.engines.vex.claripy.irop import vexop_to_simop
from bisa.analyses import ForwardAnalysis, visitors
from bisa.analyses.typehoon.typevars import Equivalence, TypeVariable, TypeVariables, Subtype, DerivedTypeVariable
from bisa.analyses.typehoon.typeconsts import Int, TypeConstant, BottomType, TopType
from bisa.analyses.typehoon.lifter import TypeLifter
...
if TYPE_CHECKING:
    from bisa.analyses.typehoon.typevars import TypeConstraint
...
class VariableRecoveryFast(ForwardAnalysis, VariableRecoveryBase):  # pylint:disable=abstract-method
    ...
    def __init__(
        ...
        if not func.block_addrs_set or func.startpoint is None:
            raise BISAVariableRecoveryError(f"Function {func!r} is empty.")
    ...
    def _initial_abstract_state(self, node):
        ...
        if self.project.arch.name.startswith("MIPS"):
            ...
            except bisa.errors.SimMemoryMissingError:
                state.register_region.store(t9_offset, claripy.BVV(node.addr, t9_size * 8))
