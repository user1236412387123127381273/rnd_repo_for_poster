...
from bisa.errors import BISAError, BISACFGError, SimValueError, SimSolverModeError, SimError
from bisa.sim_options import BYPASS_VERITESTING_EXCEPTIONS
from bisa.sim_manager import SimulationManager
from bisa.utils.graph import shallow_reverse
...
class Veritesting(Analysis):
    ...
    def _veritesting(self) -> tuple[bool, SimulationManager]:
        ...
        except (ClaripyError, SimError, BISAError):
