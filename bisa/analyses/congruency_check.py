...
from bisa.errors import BISAIncongruencyError
...
class CongruencyCheck(Analysis):
    """
    This is an analysis to ensure that bisa executes things identically with different execution backends (i.e., unicorn
    vs vex).
    """
    ...
    def _report_incongruency(self, *args):
        l.warning(*args)
        if self._throw:
            raise BISAIncongruencyError(*args)
