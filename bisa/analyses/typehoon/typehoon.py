...
from bisa.sim_type import SimStruct, SimTypePointer, SimTypeArray
from bisa.errors import BISARuntimeError
from bisa.analyses.analysis import Analysis, AnalysesHub
from bisa.sim_variable import SimVariable, SimStackVariable
...
class Typehoon(Analysis):
    ...
    bisa team. Now I feel really bad of asking the poor guy to work directly on VEX IR without any fancy static analysis
    ...
    def pp_solution(self) -> None:
        ...
        if self.solution is None:
            raise BISARuntimeError("Please run type solver before calling pp_solution().")
