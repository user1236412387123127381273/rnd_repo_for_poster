...
from bisa.analyses import AnalysesHub, Analysis, CFGFast
from bisa.errors import SimEngineError, SimMemoryError
...
class FunctionDiff:
    ...
    def __init__(self, function_a: Function, function_b: Function, bindiff=None):
        """
        :param function_a: The first bisa Function object to diff.
        :param function_b: The second bisa Function object.
...
class BinDiff(Analysis):
    """
    This class computes the a diff between two binaries represented by bisa Projects
    """
