...
from bisa import sim_options as so
from bisa import SIM_LIBRARIES
from bisa import BP_BEFORE, BP_AFTER
from bisa.storage.file import SimFile, SimFileDescriptor
from bisa.state_plugins import SimSystemPosix
from bisa.errors import BISACallableMultistateError, BISACallableError, BISAError, SimError
...
class Runner:
    ...
    def _get_recv_state(self):
        try:
            ...
            return self.project.factory.entry_state()
        except BISAError as e:
            l.warning("BISAError in get recv state %s", e)
            return self.project.factory.entry_state()
    ...
    def test(self, function, test_data, concrete_rand=False, custom_offs=None):
        ...
        except BISACallableMultistateError as e:
            l.info("multistate error: %s", e)
            return False
        except BISACallableError as e:
