...
from bisa import options
from bisa.errors import BISAError, SimSegfaultError, SimEngineError, SimMemoryError, SimError
    ...
    def __init__(self, cfg=None, require_predecessors=True, only_find=None):
        ...
        for f in self._cfg.functions.values():
            ...
            try:
                ...
                l.debug("bisa translation error: %s", e)
