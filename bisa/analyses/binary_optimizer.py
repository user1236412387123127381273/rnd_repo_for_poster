...
from bisa.sim_variable import SimConstantVariable, SimRegisterVariable, SimMemoryVariable, SimStackVariable
...
class DeadAssignment:
    def __init__(self, pv):
        ...
        :param bisa.analyses.ddg.ProgramVariable pv: The assignment to remove.
        """
...
class BinaryOptimizer(Analysis):
    ...
    def _register_reallocation(self, function, data_graph):
        ...
        # esp_variable: bisa.analyses.ddg.ProgramVariable
