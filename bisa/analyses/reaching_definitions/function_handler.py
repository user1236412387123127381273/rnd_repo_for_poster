...
from bisa.sim_type import SimTypeBottom, dereference_simtype
from bisa.knowledge_plugins.key_definitions.atoms import Atom, Register, MemoryLocation, SpOffset
from bisa.knowledge_plugins.key_definitions.tag import Tag
...
if TYPE_CHECKING:
    ...
    from bisa.analyses.reaching_definitions.reaching_definitions import ReachingDefinitionsAnalysis, ObservationPoint
