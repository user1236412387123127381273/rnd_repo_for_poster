...
from bisa.analyses.s_propagator import SPropagatorAnalysis
from bisa.analyses.s_reaching_definitions import SRDAModel
from bisa.utils.ail import is_phi_assignment, HasExprWalker
from bisa.utils.ssa import has_call_in_between_stmts, has_store_stmt_in_between_stmts, has_load_expr_in_between_stmts
from bisa.code_location import CodeLocation, ExternalCodeLocation
from bisa.sim_variable import SimStackVariable, SimMemoryVariable, SimVariable
from bisa.knowledge_plugins.propagations.states import Equivalence
...
from bisa.knowledge_plugins.key_definitions.constants import OP_BEFORE
from bisa.errors import BISARuntimeError
from bisa.analyses import Analysis, AnalysesHub
from bisa.utils.timing import timethis
            ...
            if isinstance(the_def.codeloc, ExternalCodeLocation) or (
                ...
                if isinstance(eq.atom0, VirtualVariable) and eq.atom0.was_stack:
                    ...
                    if isinstance(eq.atom1, VirtualVariable) and eq.atom1.was_reg:
                        ...
                        raise BISARuntimeError(f"Unsupported atom1 type {type(eq.atom1)}.")
                else:
                    raise BISARuntimeError(f"Unsupported atom0 type {type(eq.atom0)}.")
