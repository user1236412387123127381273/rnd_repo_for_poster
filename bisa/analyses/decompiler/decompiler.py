...
from bisa.analyses.cfg import CFGFast
from bisa.knowledge_plugins.functions.function import Function
from bisa.knowledge_base import KnowledgeBase
from bisa.sim_variable import SimMemoryVariable, SimRegisterVariable, SimStackVariable
...
if TYPE_CHECKING:
    ...
    from bisa.analyses.typehoon.typevars import TypeVariable, TypeConstraint
