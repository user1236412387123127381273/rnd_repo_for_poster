...
from bisa.knowledge_plugins.cfg import IndirectJumpType
from bisa.analyses.decompiler.graph_region import GraphRegion
from bisa.analyses.decompiler.empty_node_remover import EmptyNodeRemover
from bisa.analyses.decompiler.jumptable_entry_condition_rewriter import JumpTableEntryConditionRewriter
from bisa.analyses.decompiler.condition_processor import ConditionProcessor
from bisa.analyses.decompiler.region_simplifiers.cascading_cond_transformer import CascadingConditionTransformer
from bisa.analyses.decompiler.utils import (
        ...
        if self._region.cyclic:
            if not has_cycle:
                l.critical(
                    ...
                    "due to the existence of loop headers with more than one in-edges, which bisa decompiler "
...
# delayed import
from bisa.analyses.decompiler.sequence_walker import SequenceWalker  # pylint:disable=wrong-import-position
