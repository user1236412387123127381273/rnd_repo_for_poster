...
from bisa.analyses.decompiler.label_collector import LabelCollector
from bisa.errors import BISADecompilationError
from bisa.knowledge_plugins.cfg import IndirectJump
    ...
    def _loop_create_break_node(self, last_stmt, loop_successor_addrs):
        ...
        if type(last_stmt) is ailment.Stmt.Jump:
            ...
            if (true_target_value is not None and true_target_value in loop_successor_addrs) and (
                ...
                raise BISADecompilationError("Unexpected: None of the branches is jumping to outside of the loop")
