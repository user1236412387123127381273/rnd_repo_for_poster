...
from bisa.analyses.decompiler.structuring.structurer_nodes import SwitchCaseNode
...
class SwitchExpressionSimplifier(SequenceWalker):
    ...
    def _handle_SwitchCase(self, node: SwitchCaseNode, **kwargs):
        ...
        from bisa.analyses.decompiler.peephole_optimizations.remove_noop_conversions import RemoveNoopConversions
