...
import ailment
from bisa import SIM_LIBRARIES, SIM_TYPE_COLLECTIONS

from bisa.errors import BISADecompilationError
...
from bisa.knowledge_plugins.key_definitions import atoms
from bisa.codenode import BlockNode
from bisa.utils import timethis
from bisa.utils.graph import GraphUtils
from bisa.calling_conventions import SimRegArg, SimStackArg, SimFunctionArgument
...
from bisa.analyses.stack_pointer_tracker import Register, OffsetVal
from bisa.sim_variable import SimVariable, SimStackVariable, SimRegisterVariable, SimMemoryVariable
from bisa.procedures.stubs.UnresolvableCallTarget import UnresolvableCallTarget
from bisa.procedures.stubs.UnresolvableJumpTarget import UnresolvableJumpTarget
from bisa.analyses import Analysis, register_analysis
from bisa.analyses.cfg.cfg_base import CFGBase
from bisa.analyses.reaching_definitions import ReachingDefinitionsAnalysis
...
class Clinic(Analysis):
    ...
    def _function_graph_to_ail_graph(self, func_graph, blocks_by_addr_and_size=None):
        ...
        if ail_block is None:
            raise BISADecompilationError(f"AIL block at address {entry_node.addr:#x} not found")
