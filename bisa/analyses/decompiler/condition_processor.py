...
from bisa.utils.lazy_import import lazy_import
from bisa.utils import is_pyinstaller
from bisa.utils.graph import dominates, inverted_idoms
from bisa.utils.ail import is_head_controlled_loop_block
from bisa.block import Block, BlockNode
        ...
        if cond.op == "Or":
            ...
            for arg in args:
                if arg.op == "And":
                    ...
                    raise BISARuntimeError("Unexpected behavior - you should never reach here")
