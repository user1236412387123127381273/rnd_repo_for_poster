...
from bisa.procedures import SIM_LIBRARIES, SIM_TYPE_COLLECTIONS
...
from bisa.sim_variable import SimVariable, SimTemporaryVariable, SimStackVariable, SimMemoryVariable
from bisa.utils.constants import is_alignment_mask
from bisa.utils.library import get_cpp_function_name
from bisa.utils.loader import is_in_readonly_segment, is_in_readonly_section
from bisa.utils.types import unpack_typeref, unpack_pointer_and_array
from bisa.analyses.decompiler.utils import structured_node_is_simple_return
from bisa.errors import UnsupportedNodeTypeError, BISARuntimeError
from bisa.knowledge_plugins.cfg.memory_data import MemoryData, MemoryDataSort
from bisa.analyses import Analysis, register_analysis
from bisa.analyses.decompiler.region_identifier import MultiNode
...
def guess_value_type(value: int, project: bisa.Project) -> SimType | None:
...
class CConstruct:
    ...
    def c_repr(self, indent=0, pos_to_node=None, pos_to_addr=None, addr_to_pos=None):
        ...
        # the chunks that get printed in qccode_edit in bisa-management.
...
class CFunctionCall(CStatement, CExpression):
    ...
    def type(self):
        ...
        raise BISARuntimeError("CFunctionCall.type should not be accessed if the function call is used as a statement.")
