...
from bisa.analyses.decompiler.condition_processor import ConditionProcessor, EmptyBlockNotice
from bisa.analyses.decompiler.graph_region import GraphRegion
from bisa.analyses.decompiler.utils import remove_labels, to_ail_supergraph, calls_in_graph
from bisa.analyses.decompiler.structuring.structurer_nodes import MultiNode, ConditionNode
from bisa.analyses.decompiler.region_identifier import RegionIdentifier
...
class ReturnDuplicatorBase:
    ...
    def _is_simple_return_graph(graph: networkx.DiGraph, max_assigns=1):
        ...
        If there were absolutely no bugs in bisa, we could just check that a single return block exists.
