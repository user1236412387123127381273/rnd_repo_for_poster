...
from bisa.analyses.decompiler.utils import first_nonlabel_nonphi_statement, remove_last_statement
...
from bisa.analyses.decompiler.region_simplifiers.switch_cluster_simplifier import SwitchClusterFinder
...
class LoweredSwitchSimplifier(StructuringOptimizationPass):
    ...
    def _find_cascading_switch_variable_comparisons(self):
        ...
        for head in variable_comparisons:
            ...
            # See https://github.com/bisa/bisa/pull/4953
            #
