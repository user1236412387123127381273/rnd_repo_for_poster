...
from bisa.code_location import ExternalCodeLocation, CodeLocation

from bisa.knowledge_plugins.key_definitions import atoms
from bisa.analyses.s_propagator import SPropagatorAnalysis
from bisa.analyses.s_reaching_definitions import SReachingDefinitionsAnalysis, SRDAModel
...
if TYPE_CHECKING:
    from bisa.knowledge_plugins.key_definitions.live_definitions import Definition
