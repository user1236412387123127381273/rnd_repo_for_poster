...
from bisa.utils.graph import dfs_back_edges, subgraph_between_nodes, dominates
from bisa.utils.doms import IncrementalDominators
    ...
    def _get_start_node(self, graph: networkx.DiGraph):
        ...
        if self.entry_node_addr is not None:
            try:
                ...
                raise BISARuntimeError("Cannot find the start node from the graph!") from ex
        raise BISARuntimeError("Cannot find the start node from the graph!")
