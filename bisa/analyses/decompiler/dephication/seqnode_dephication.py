...
from bisa.analyses.decompiler.structuring.structurer_nodes import SequenceNode, LoopNode
...
class SeqNodeRewriter(SequenceWalker):
    ...
    def __init__(self, seq_node: SequenceNode, vvar_to_vvar: dict[int, int], project: bisa.Project):
        super().__init__(
            handlers={
                Block: self._handle_Block,
                # statement handlers
