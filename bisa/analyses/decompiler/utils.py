...
import bisa
from bisa.analyses.decompiler.counters.call_counter import AILBlockCallCounter
...
def decompile_functions(
    ...
    from bisa.analyses.decompiler.structuring import DEFAULT_STRUCTURER
    ...
    proj = bisa.Project(path, auto_load_libs=False, main_opts=loader_main_opts_kwargs)
