...
class FlirtAnalysis(Analysis):
    ...
    def __init__(self, sig: FlirtSignature | str | None = None, max_mismatched_bytes: int = 0):
        ...
        from bisa.flirt import FLIRT_SIGNATURES_BY_ARCH  # pylint:disable=import-outside-toplevel
    ...
    def _find_hits_by_strings(self, regions: list[bytes]) -> Generator[FlirtSignature]:
        ...
        from bisa.flirt import STRING_TO_LIBRARIES, LIBRARY_TO_SIGNATURES  # pylint:disable=import-outside-toplevel
