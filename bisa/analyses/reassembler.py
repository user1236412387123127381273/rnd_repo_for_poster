...
from bisa.codenode import CodeNode
...
from bisa.sim_variable import SimMemoryVariable, SimTemporaryVariable
...
class SymbolManager:
    ...
    def __init__(self, binary, cfg):
        ...
        :param bisa.analyses.CFG cfg: The CFG analysis instance.
        :return: None
        """
    ...
    def new_label(self, addr, name=None, is_function=None, force=False):
        ...
        if addr in reverse_plt:
            ...
            # It's a function identified by bisa's CFG recovery
    ...
    def label_got(self, addr, label):
        ...
        :param bisa.analyses.reassembler.Label label:
...
class Procedure:
    ...
    def __init__(self, binary, function=None, addr=None, size=None, name=None, section=".text", asm_code=None):
        ...
        :param Reassembler binary: The Binary analysis.
        :param bisa.knowledge.Function function: The function it represents
    ...
    def _initialize(self):
        if self.function is None:
            if not self.asm_code:
                raise BinaryError(
                    "Unsupported procedure type. You must either specify a bisa.knowledge.Function "
...
class Reassembler(Analysis):
    ...
    def _sequence_handler(self, cfg, irsb, irsb_addr, stmt_idx, data_addr, max_size):  # pylint:disable=unused-argument
        ...
        :param bisa.analyses.CFG cfg: The control flow graph.
