#ifndef BISA_UNICORN_API
#define BISA_UNICORN_API extern
#endif
...
*/
BISA_UNICORN_API unsigned int (*uc_version)(unsigned int *major, unsigned int *minor);
...
*/
BISA_UNICORN_API bool (*uc_arch_supported)(uc_arch arch);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
BISA_UNICORN_API uc_err (*uc_open)(uc_arch arch, uc_mode mode, uc_engine **uc);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
BISA_UNICORN_API uc_err (*uc_close)(uc_engine *uc);
...
*/
BISA_UNICORN_API uc_err (*uc_query)(uc_engine *uc, uc_query_type type, size_t *result);
...
/*
 ...
 @return: error code of uc_err enum type (UC_ERR_*, see above)
*/
BISA_UNICORN_API uc_err (*uc_ctl)(uc_engine *uc, uc_control_type control, ...);
...
/*
 ...
 @return: error code of uc_err enum type (UC_ERR_*, see above)
*/
BISA_UNICORN_API uc_err (*uc_errno)(uc_engine *uc);
 ...
 */
BISA_UNICORN_API const char *(*uc_strerror)(uc_err code);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
BISA_UNICORN_API uc_err (*uc_reg_write)(uc_engine *uc, int regid, const void *value);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
BISA_UNICORN_API uc_err (*uc_reg_read)(uc_engine *uc, int regid, void *value);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
BISA_UNICORN_API uc_err (*uc_reg_write_batch)(uc_engine *uc, int *regs, void *const *vals,
                          int count);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
BISA_UNICORN_API uc_err (*uc_reg_read_batch)(uc_engine *uc, int *regs, void **vals, int count);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
BISA_UNICORN_API uc_err (*uc_mem_write)(uc_engine *uc, uint64_t address, const void *bytes,
                    size_t size);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
BISA_UNICORN_API uc_err (*uc_mem_read)(uc_engine *uc, uint64_t address, void *bytes, size_t size);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
BISA_UNICORN_API uc_err (*uc_emu_start)(uc_engine *uc, uint64_t begin, uint64_t until,
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
BISA_UNICORN_API uc_err (*uc_emu_stop)(uc_engine *uc);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
BISA_UNICORN_API uc_err (*uc_hook_add)(uc_engine *uc, uc_hook *hh, int type, void *callback,
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
BISA_UNICORN_API uc_err (*uc_hook_del)(uc_engine *uc, uc_hook hh);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
BISA_UNICORN_API uc_err (*uc_mem_map)(uc_engine *uc, uint64_t address, size_t size, uint32_t perms);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
BISA_UNICORN_API uc_err (*uc_mem_map_ptr)(uc_engine *uc, uint64_t address, size_t size,
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
 */
BISA_UNICORN_API uc_err (*uc_mmio_map)(uc_engine *uc, uint64_t address, size_t size,
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
BISA_UNICORN_API uc_err (*uc_mem_unmap)(uc_engine *uc, uint64_t address, size_t size);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
BISA_UNICORN_API uc_err (*uc_mem_protect)(uc_engine *uc, uint64_t address, size_t size,
                      uint32_t perms);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
BISA_UNICORN_API uc_err (*uc_mem_regions)(uc_engine *uc, uc_mem_region **regions, uint32_t *count);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
BISA_UNICORN_API uc_err (*uc_context_alloc)(uc_engine *uc, uc_context **context);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
BISA_UNICORN_API uc_err (*uc_free)(void *mem);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
BISA_UNICORN_API uc_err (*uc_context_save)(uc_engine *uc, uc_context *context);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
BISA_UNICORN_API uc_err (*uc_context_reg_write)(uc_context *ctx, int regid, const void *value);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
BISA_UNICORN_API uc_err (*uc_context_reg_read)(uc_context *ctx, int regid, void *value);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
BISA_UNICORN_API uc_err (*uc_context_reg_write_batch)(uc_context *ctx, int *regs, void *const *vals,
                                  int count);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
BISA_UNICORN_API uc_err (*uc_context_reg_read_batch)(uc_context *ctx, int *regs, void **vals,
                                 int count);
...
/*
 ...
 @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
BISA_UNICORN_API uc_err (*uc_context_restore)(uc_engine *uc, uc_context *context);
...
*/
BISA_UNICORN_API size_t (*uc_context_size)(uc_engine *uc);
...
/*
  ...
  @return UC_ERR_OK on success, or other value on failure (refer to uc_err enum
   for detailed error).
*/
BISA_UNICORN_API uc_err (*uc_context_free)(uc_context *context);
