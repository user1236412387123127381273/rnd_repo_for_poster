...
The performance of bisa as an analysis tool or emulator is greatly handicapped
by the fact that lots of it is written in Python. Regardless, there are a lot of
optimizations and tweaks you can use to make bisa faster and lighter.
...
* *Use SimInspect*. :ref:`SimInspect <Breakpoints>` is the most underused and
  ...
  slowest part of any bisa analysis).
* *Write a concretization strategy*. A more powerful solution to the problem of
  ...
  <https://github.com/bisa/bisa/tree/master/bisa/concretization_strategies>`_.
