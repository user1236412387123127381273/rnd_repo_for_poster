...
``bisa`` also supports symbolically executing Java code and Android apps! This
...
We then leverage the generated IR in a new bisa engine able to run code in Soot
...
default bisa installation. You can install it from GitHub using pip:
...
Alternatively, pysoot can be installed with the setup script in bisa-dev:
...
* Easy Java crackmes: `java_crackme1
  ...
  `java_simple4
  <https://github.com/bisa/bisa-examples/tree/master/examples/java_simple4>`_
* A more complex example (solving a CTF challenge): `ictf2017_javaisnotfun
  ...
  `blogpost <https://bisa.io/blog/java_bisa/>`_
* Symbolically executing an Android app (using a mix of Java and native code):
  `java_androidnative1
  <https://github.com/bisa/bisa-examples/tree/master/examples/java_androidnative1>`_
* Many other low-level tests: `test_java
  <https://github.com/bisa/bisa/blob/master/tests/engines/test_java.py>`_
