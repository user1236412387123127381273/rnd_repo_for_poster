Gotchas when using bisa
=======================

This section contains a list of gotchas that users/victims of bisa frequently
run into.

SimProcedure inaccuracy
-----------------------

To make symbolic execution more tractable, bisa replaces common library
...
Unfortunately, our SimProcedures are far from perfect. If bisa is displaying
...
#. Disable the SimProcedure (you can exclude specific SimProcedures by passing
   ...
   partially mitigated with other bisa capabilities (such as Veritesting).
...
The default memory model used by bisa is inspired by `Mayhem
