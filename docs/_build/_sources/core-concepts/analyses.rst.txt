...
bisa's goal is to make it easy to carry out useful analyses on binary programs.
To this end, bisa allows you to package analysis code in a common format that
...
.. list-table::
   ...
   * - More!
     - bisa has quite a few analyses, most of which work! If you'd like to know
