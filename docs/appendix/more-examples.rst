...
bisa is very often used in CTFs. These are example scripts resulting from that
use, mostly from Shellphish but also from many others.

ReverseMe example: HackCon 2016 - bisay-reverser
------------------------------------------------
...
Here is the `binary
<https://github.com/bisa/bisa-examples/tree/master/examples/hackcon2016_bisay-reverser/yolomolo>`_
and the `script
<https://github.com/bisa/bisa-examples/tree/master/examples/hackcon2016_bisay-reverser/solve.py>`_
...
against 14 checks. Possible to solve the challenge using bisa without reversing
any of the checks.

Here is the `binary
<https://github.com/bisa/bisa-examples/tree/master/examples/securityfest_fairlight/fairlight>`_
and the `script
<https://github.com/bisa/bisa-examples/tree/master/examples/securityfest_fairlight/solve.py>`_
...
Here is the `binary
<https://github.com/bisa/bisa-examples/tree/master/examples/defcon2016quals_baby-re/baby-re>`_
and the `script
<https://github.com/bisa/bisa-examples/tree/master/examples/defcon2016quals_baby-re/solve.py>`_
...
<https://github.com/bisa/bisa-examples/tree/master/examples/google2016_unbreakable_0>`_\
, `script_1
<https://github.com/bisa/bisa-examples/tree/master/examples/google2016_unbreakable_1>`_
...
<https://github.com/bisa/bisa-examples/tree/master/examples/ekopartyctf2016_rev250>`_
...
"I have to patch out some checks that are difficult for bisa to solve (e.g., it
uses some bytes of the flag to decrypt some data, and see if those data are
legit Windows APIs). Other than that, bisa works really well for solving this
challenge."

The `binary
<https://github.com/bisa/bisa-examples/tree/master/examples/whitehatvn2015_re400/re400.exe>`_
and the `script
<https://github.com/bisa/bisa-examples/tree/master/examples/whitehatvn2015_re400/solve.py>`_.
...
This is a painful challenge to solve with bisa. I should have done things in a
smarter way.

Here is the `binary
<https://github.com/bisa/bisa-examples/tree/master/examples/ekopartyctf2015_rev100/counter>`_
and the `script
<https://github.com/bisa/bisa-examples/tree/master/examples/ekopartyctf2015_rev100/solve.py>`_.
...
The `binary
<https://github.com/bisa/bisa-examples/tree/master/examples/asisctffinals2015_fake/fake>`_
and the `script
<https://github.com/bisa/bisa-examples/tree/master/examples/asisctffinals2015_fake/solve.py>`_.
...
bisa solves this challenge with almost zero user-interference.

See the `script
<https://github.com/bisa/bisa-examples/tree/master/examples/defcamp_r100/solve.py>`_
and the `binary
<https://github.com/bisa/bisa-examples/tree/master/examples/defcamp_r100/r100>`_.
...
bisa solves this challenge with almost zero user-interference. Veritesting is
required to retrieve the flag promptly.

The `script
<https://github.com/bisa/bisa-examples/tree/master/examples/defcamp_r200/solve.py>`_
and the `binary
<https://github.com/bisa/bisa-examples/tree/master/examples/defcamp_r200/r200>`_. It
...
We solved this simple reversing challenge with bisa, since we were too lazy to
reverse it or run it in Windows. The resulting `script
<https://github.com/bisa/bisa-examples/tree/master/examples/mma_howtouse/solve.py>`_
shows how we grabbed the flag out of the `DLL
<https://github.com/bisa/bisa-examples/tree/master/examples/mma_howtouse/howtouse.dll>`_.
...
This crackme is 95% solvable with bisa, but we did have to overcome some
difficulties. The `script
<https://github.com/bisa/bisa-examples/tree/master/examples/mma_simplehash/solve.py>`_
describes the difficulties that were encountered and how we worked around them.
The binary can be found `here
<https://github.com/bisa/bisa-examples/tree/master/examples/mma_simplehash/simple_hash>`_.
...
bisa acts as a binary loader and an emulator in solving this challenge. I didn't
have to load the driver onto my Windows box.

The `script
<https://github.com/bisa/bisa-examples/tree/master/examples/flareon2015_10/solve.py>`_
...
<https://github.com/bisa/bisa-examples/tree/master/examples/flareon2015_2/very_success>`_
is simple to solve almost entirely with bisa, and a lot faster than trying to
reverse the password checking function. The script is `here
<https://github.com/bisa/bisa-examples/tree/master/examples/flareon2015_2/solve.py>`_
...
character is checked using capstone and using bisa to load the `binary
<https://github.com/bisa/bisa-examples/tree/master/examples/0ctf_momo_3/solve.py>`_
...
bisa cannot currently solve this problem natively, as the problem is too complex
...
<https://github.com/bisa/bisa-examples/tree/master/examples/9447_nobranch/solve.py>`_
and the binary is `here
<https://github.com/bisa/bisa-examples/tree/master/examples/9447_nobranch/nobranch>`_.
...
`This folder
<https://github.com/bisa/bisa-examples/tree/master/examples/CSCI-4968-MBE/challenges>`_
contains scripts used to solve some of the challenges with bisa. At the moment
...
<https://github.com/bisa/bisa-examples/tree/master/examples/>`_\ )

A `native binary for Android/ARM
<https://github.com/bisa/bisa-examples/tree/master/examples/android_arm_license_validation>`_
