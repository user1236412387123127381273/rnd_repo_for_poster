...
project = "bisa"
project_copyright = f"{datetime.datetime.now().year}, The bisa Project contributors"
author = "The bisa Project"
...
coverage_ignore_pyobjects = [
    "bisa.analyses.decompiler.structured_codegen.c.StructuredCodeGenerator",  # Alias to CStructuredCodeGenerator
    "bisa.sim_type.SimTypeFixedSizeArray",  # Alias to SimTypeArray
]
